...
import org.lzq.partnermatchbackend.constant.RedisKeyConstant;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    private List<TeamUserVO> setTeamJoinStatus(List<TeamUserVO> teamList, HttpServletRequest request) {
        ...
        if (org.springframework.util.CollectionUtils.isEmpty(teamIdList)) {
            return null;
        }
        // 2. 判断当前用户是否已加入队伍
